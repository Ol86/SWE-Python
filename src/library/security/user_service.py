...
from library.config import keycloak_admin_config
...
class UserService:
    ...
    def create_user(self, user: User) -> str:
        ...
        self.keycloak_admin.assign_client_role(user_id=user_id, client_id=self.client_uuid, roles=[self.rolle_patient])
        return user_id
    ...
    def find_user_by_username(self, username: str) -> User | None:
        ...
        kc_client_roles = kc_roles["clientMappings"][keycloak_admin_config.client_id]["mappings"]
