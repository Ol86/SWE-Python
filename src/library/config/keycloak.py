...
class KeycloakConfig:
    """General configuratio for keycloak."""
...
class KeycloakAdminConfig(KeycloakConfig):
    """Configurationfile for the general keycloak administration."""
...
"""Administration for keycloak."""

logger.debug("keycloak: keycloak_config={}", keycloak_config)

csv_config: Final = _keycloak_toml.get("csv", "/csv/library.csv")
